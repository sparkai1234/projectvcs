-- 🗺️ DIVA VC MAP & ⚖️ VIOLATIONS TABLES - FIXED VERSION
-- ================================================================
...
-- ⚠️ Note: Foreign key constraints removed to avoid constraint errors
...
SELECT 
    v.company_name,
    v.company_id,
    v.location,                             -- From original vc_table (correct column name)
    v.company_type,                         -- From original vc_table (correct column name)
    v.representative,                       -- From original vc_table (correct column name)
...
GROUP BY v.company_name, v.company_id, v.location, v.company_type, v.representative, v.updated_at;
...
SELECT 'VC MAP and Violations tables created successfully - NO FOREIGN KEY ERRORS!' as status; 