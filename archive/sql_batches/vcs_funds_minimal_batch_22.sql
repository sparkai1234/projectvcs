-- VCS Fund MINIMAL UPSERT Batch 22/74 (Records 1051-1100)
-- MINIMAL: Only using basic columns that definitely exist
-- Generated from VCS API Scraper fund data
-- Generated at: 2025-06-05T00:40:21.799Z
...
INSERT INTO fund_table (
  ...
  20000000000,
  '2022-06-16',
  '{"fund_id":"AS20220677","registration_date":"2022-06-16","expiry_date":"2030-06-15","formation_total_amount":"200.0","investment_character_code":"24","industry_code":"6","investment_field_type":"문화","investment_field_detail_type":"영상(영화+드라마+애니메이션)","mother_fund_id":"MF00000001","operator_company_id":"OP20000026","operator_company_name":"이에스인베스터","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이에스인베스터","investment_focus":["영상(영화+드라마+애니메이션)","문화"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.799Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  15550000000,
  '2021-07-20',
  '{"fund_id":"AS20210616","registration_date":"2021-07-20","expiry_date":"2029-07-19","formation_total_amount":"155.5","investment_character_code":"20","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20000026","operator_company_name":"이에스인베스터","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이에스인베스터","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.799Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  12600000000,
  '2021-01-05',
  '{"fund_id":"AS20210029","registration_date":"2021-01-05","expiry_date":"2029-01-04","formation_total_amount":"126.0","investment_character_code":"10","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20000026","operator_company_name":"이에스인베스터","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이에스인베스터","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.799Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  10000000000,
  '2019-02-14',
  '{"fund_id":"AS20190043","registration_date":"2019-02-14","expiry_date":"2028-02-13","formation_total_amount":"100.0","investment_character_code":"20","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20000026","operator_company_name":"이에스인베스터","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이에스인베스터","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  12000000000,
  '2017-10-17',
  '{"fund_id":"AS20170122","registration_date":"2017-10-17","expiry_date":"2025-10-16","formation_total_amount":"120.0","investment_character_code":"20","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20000026","operator_company_name":"이에스인베스터","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이에스인베스터","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  17000000000,
  '2022-12-02',
  '{"fund_id":"AS20221398","registration_date":"2022-12-02","expiry_date":"2030-12-01","formation_total_amount":"170.0","investment_character_code":"10","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20000026","operator_company_name":"이에스인베스터","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이에스인베스터","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  5100000000,
  '2023-06-29',
  '{"fund_id":"AS20230549","registration_date":"2023-06-29","expiry_date":"2028-06-28","formation_total_amount":"51.0","investment_character_code":"25","industry_code":"3","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20180007","operator_company_name":"이앤벤처파트너스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이앤벤처파트너스","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  100000000,
  '2023-11-07',
  '{"fund_id":"AS20231007","registration_date":"2023-11-07","expiry_date":"2028-11-06","formation_total_amount":"1.0","investment_character_code":"","industry_code":"5","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20220622","operator_company_name":"이디리서치","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이디리서치","investment_focus":[],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  40000000000,
  '2024-01-16',
  '{"fund_id":"AS20240039","registration_date":"2024-01-16","expiry_date":"2032-01-15","formation_total_amount":"400.0","investment_character_code":"18","industry_code":"3","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20060006","operator_company_name":"이노폴리스파트너스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이노폴리스파트너스","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  25000000000,
  '2021-12-29',
  '{"fund_id":"AS20211434","registration_date":"2021-12-29","expiry_date":"2031-12-28","formation_total_amount":"250.0","investment_character_code":"10","industry_code":"3","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20060006","operator_company_name":"이노폴리스파트너스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이노폴리스파트너스","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  43300000000,
  '2021-01-05',
  '{"fund_id":"AS20210034","registration_date":"2021-01-05","expiry_date":"2031-01-04","formation_total_amount":"433.0","investment_character_code":"09","industry_code":"5","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20060006","operator_company_name":"이노폴리스파트너스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이노폴리스파트너스","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  31100000000,
  '2015-12-22',
  '{"fund_id":"AS20150106","registration_date":"2015-12-22","expiry_date":"2025-12-21","formation_total_amount":"311.0","investment_character_code":"06","industry_code":"3","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20060006","operator_company_name":"이노폴리스파트너스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"이노폴리스파트너스","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  170000000,
  '2023-08-25',
  '{"fund_id":"AS20230695","registration_date":"2023-08-25","expiry_date":"2028-08-24","formation_total_amount":"1.7","investment_character_code":"","industry_code":"2","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20200331","operator_company_name":"더이노베이터스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"더이노베이터스","investment_focus":[],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  210000000,
  '2022-01-20',
  '{"fund_id":"AS20220070","registration_date":"2022-01-20","expiry_date":"2027-01-19","formation_total_amount":"2.1","investment_character_code":"","industry_code":"2","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20200331","operator_company_name":"더이노베이터스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"더이노베이터스","investment_focus":[],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  400000000,
  '2024-02-06',
  '{"fund_id":"AS20240073","registration_date":"2024-02-06","expiry_date":"2029-02-05","formation_total_amount":"4.0","investment_character_code":"","industry_code":"2","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20200331","operator_company_name":"더이노베이터스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"더이노베이터스","investment_focus":[],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  1650000000,
  '2024-07-08',
  '{"fund_id":"AS20240600","registration_date":"2024-07-08","expiry_date":"2029-07-07","formation_total_amount":"16.5","investment_character_code":"","industry_code":"8","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20210161","operator_company_name":"테일벤처스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"테일벤처스","investment_focus":[],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  5000000000,
  '2023-05-03',
  '{"fund_id":"AS20230353","registration_date":"2023-05-03","expiry_date":"2028-05-02","formation_total_amount":"50.0","investment_character_code":"25","industry_code":"3","investment_field_type":"일반","investment_field_detail_type":"부품소재","mother_fund_id":"","operator_company_id":"OP20220015","operator_company_name":"플럭스벤처스","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"플럭스벤처스","investment_focus":["부품소재","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
INSERT INTO fund_table (
  ...
  12000000000,
  '2025-03-24',
  '{"fund_id":"AS20250212","registration_date":"2025-03-24","expiry_date":"2030-03-23","formation_total_amount":"120.0","investment_character_code":"28","industry_code":"9","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190209","operator_company_name":"유진투자증권","fund_type":"VCS Registered Fund","fund_status":"Active","representative":"유진투자증권","investment_focus":["중소/벤처일반","일반"],"source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:40:21.800Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  commitment_amount = EXCLUDED.commitment_amount,
...
-- Minimal Batch 22 completed! 50 fund records processed.
