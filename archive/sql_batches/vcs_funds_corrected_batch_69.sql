-- VCS Fund CORRECTED UPSERT Batch 69/74 (Records 3401-3450)
-- FIXED: Removed fund_name_en column that does not exist
-- Generated from VCS API Scraper fund data
-- Generated at: 2025-06-05T00:34:30.419Z
...
INSERT INTO fund_table (
  ...
  '와이앤아처',
  NULL,
  '{"fund_id":"AS20180120","registration_date":"2017-12-04","expiry_date":"2025-12-03","formation_total_amount":"2.4","investment_character_code":"","industry_code":"2","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20150027","operator_company_name":"와이앤아처","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.419Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '트랜스링크인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20180026","registration_date":"2017-12-29","expiry_date":"2025-12-28","formation_total_amount":"350.0","investment_character_code":"21","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20200513","operator_company_name":"트랜스링크인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.419Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '에스브이인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20160050","registration_date":"2016-07-28","expiry_date":"2025-07-27","formation_total_amount":"681.0","investment_character_code":"16","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20060002","operator_company_name":"에스브이인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.419Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '에스엘인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20170061","registration_date":"2017-06-22","expiry_date":"2025-06-21","formation_total_amount":"960.0","investment_character_code":"01","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20000040","operator_company_name":"에스엘인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.419Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '에스엘인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20130022","registration_date":"2013-12-23","expiry_date":"2025-06-22","formation_total_amount":"200.0","investment_character_code":"01","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20000040","operator_company_name":"에스엘인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.419Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '스마트파머',
  NULL,
  '{"fund_id":"AS20200448","registration_date":"2020-08-28","expiry_date":"2025-12-30","formation_total_amount":"2.3","investment_character_code":"","industry_code":"6","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20160035","operator_company_name":"스마트파머","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.419Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '트랜스링크인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20170080","registration_date":"2017-08-01","expiry_date":"2025-07-31","formation_total_amount":"187.0","investment_character_code":"20","industry_code":"4","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20200513","operator_company_name":"트랜스링크인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.419Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '트랜스링크인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20190516","registration_date":"2019-11-13","expiry_date":"2027-11-12","formation_total_amount":"272.5","investment_character_code":"20","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20200513","operator_company_name":"트랜스링크인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.419Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
-- Corrected Batch 69 completed! 50 fund records processed.
