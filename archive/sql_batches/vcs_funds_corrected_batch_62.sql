-- VCS Fund CORRECTED UPSERT Batch 62/74 (Records 3051-3100)
-- FIXED: Removed fund_name_en column that does not exist
-- Generated from VCS API Scraper fund data
-- Generated at: 2025-06-05T00:34:30.391Z
...
INSERT INTO fund_table (
  ...
  '데브시스터즈벤처스',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20160022","registration_date":"2016-06-21","expiry_date":"2025-06-20","formation_total_amount":"150.0","investment_character_code":"20","industry_code":"7","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20150002","operator_company_name":"데브시스터즈벤처스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '데브시스터즈벤처스',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20170158","registration_date":"2017-12-22","expiry_date":"2025-12-21","formation_total_amount":"150.0","investment_character_code":"21","industry_code":"7","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20150002","operator_company_name":"데브시스터즈벤처스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '데브시스터즈벤처스',
  '{"게임","문화"}',
  '{"fund_id":"AS20180363","registration_date":"2018-12-07","expiry_date":"2026-12-06","formation_total_amount":"200.0","investment_character_code":"24","industry_code":"7","investment_field_type":"문화","investment_field_detail_type":"게임","mother_fund_id":"MF00000001","operator_company_id":"OP20150002","operator_company_name":"데브시스터즈벤처스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더웰스인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20200256","registration_date":"2020-06-08","expiry_date":"2027-06-07","formation_total_amount":"250.0","investment_character_code":"10","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20160007","operator_company_name":"더웰스인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더웰스인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20230256","registration_date":"2023-04-06","expiry_date":"2028-04-05","formation_total_amount":"101.0","investment_character_code":"25","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20160007","operator_company_name":"더웰스인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더웰스인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20210658","registration_date":"2021-07-30","expiry_date":"2027-07-29","formation_total_amount":"160.0","investment_character_code":"02","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20160007","operator_company_name":"더웰스인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더웰스인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20200336","registration_date":"2020-07-07","expiry_date":"2025-07-06","formation_total_amount":"76.0","investment_character_code":"16","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20160007","operator_company_name":"더웰스인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더웰스인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20220705","registration_date":"2022-06-23","expiry_date":"2027-06-22","formation_total_amount":"92.0","investment_character_code":"02","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20160007","operator_company_name":"더웰스인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더웰스인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20210065","registration_date":"2021-01-15","expiry_date":"2026-01-14","formation_total_amount":"130.0","investment_character_code":"02","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20160007","operator_company_name":"더웰스인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더웰스인베스트먼트',
  '{"특허","일반"}',
  '{"fund_id":"AS20180343","registration_date":"2018-11-09","expiry_date":"2026-11-08","formation_total_amount":"200.0","investment_character_code":"09","industry_code":"5","investment_field_type":"일반","investment_field_detail_type":"특허","mother_fund_id":"MF00000001","operator_company_id":"OP20160007","operator_company_name":"더웰스인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더시드인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20190035","registration_date":"2019-01-25","expiry_date":"2026-01-24","formation_total_amount":"70.5","investment_character_code":"17","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20150018","operator_company_name":"더시드인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '더시드인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20221004","registration_date":"2022-08-31","expiry_date":"2027-08-30","formation_total_amount":"55.5","investment_character_code":"16","industry_code":"8","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20150018","operator_company_name":"더시드인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.392Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
-- Corrected Batch 62 completed! 50 fund records processed.
