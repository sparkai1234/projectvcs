-- VCS Fund CORRECTED UPSERT Batch 28/74 (Records 1351-1400)
-- FIXED: Removed fund_name_en column that does not exist
-- Generated from VCS API Scraper fund data
-- Generated at: 2025-06-05T00:34:30.243Z
...
INSERT INTO fund_table (
  ...
  '오픈워터인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20210294","registration_date":"2021-04-13","expiry_date":"2028-04-12","formation_total_amount":"42.4","investment_character_code":"25","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190245","operator_company_name":"오픈워터인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
...
INSERT INTO fund_table (
  ...
  '오픈워터인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20210528","registration_date":"2021-06-28","expiry_date":"2028-06-27","formation_total_amount":"43.0","investment_character_code":"25","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190245","operator_company_name":"오픈워터인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오픈워터인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20230496","registration_date":"2023-06-16","expiry_date":"2030-06-15","formation_total_amount":"24.3","investment_character_code":"06","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190245","operator_company_name":"오픈워터인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오픈워터인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20220395","registration_date":"2022-04-06","expiry_date":"2029-04-05","formation_total_amount":"20.8","investment_character_code":"10","industry_code":"9","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190245","operator_company_name":"오픈워터인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오픈워터인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20210857","registration_date":"2021-09-14","expiry_date":"2026-09-13","formation_total_amount":"33.5","investment_character_code":"25","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190245","operator_company_name":"오픈워터인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오픈워터인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20250028","registration_date":"2025-01-09","expiry_date":"2030-01-08","formation_total_amount":"69.0","investment_character_code":"28","industry_code":"3","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190245","operator_company_name":"오픈워터인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오픈워터인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20230827","registration_date":"2023-09-14","expiry_date":"2030-09-13","formation_total_amount":"33.3","investment_character_code":"25","industry_code":"6","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190245","operator_company_name":"오픈워터인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오픈워터인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20220624","registration_date":"2022-05-31","expiry_date":"2029-05-30","formation_total_amount":"33.7","investment_character_code":"16","industry_code":"1","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190245","operator_company_name":"오픈워터인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오엔벤처투자',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20240278","registration_date":"2024-04-08","expiry_date":"2029-04-07","formation_total_amount":"340.0","investment_character_code":"06","industry_code":"5","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP20200243","operator_company_name":"오엔벤처투자","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오엔벤처투자',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20210649","registration_date":"2021-07-28","expiry_date":"2026-07-27","formation_total_amount":"100.0","investment_character_code":"16","industry_code":"3","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20200243","operator_company_name":"오엔벤처투자","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오다스톤인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20241010","registration_date":"2024-10-21","expiry_date":"2029-10-20","formation_total_amount":"23.2","investment_character_code":"25","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190019","operator_company_name":"오다스톤인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오다스톤인베스트먼트',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20240277","registration_date":"2024-04-08","expiry_date":"2031-04-07","formation_total_amount":"30.6","investment_character_code":"25","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20190019","operator_company_name":"오다스톤인베스트먼트","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '오거스트벤처파트너스',
  '{"영상(영화+드라마+애니메이션)","문화"}',
  '{"fund_id":"AS20240382","registration_date":"2024-05-03","expiry_date":"2030-05-02","formation_total_amount":"118.2","investment_character_code":"24","industry_code":"6","investment_field_type":"문화","investment_field_detail_type":"영상(영화+드라마+애니메이션)","mother_fund_id":"MF00000001","operator_company_id":"OP20230076","operator_company_name":"오거스트벤처파트너스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '옐로씨펀드',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20250284","registration_date":"2025-04-14","expiry_date":"2030-04-13","formation_total_amount":"28.5","investment_character_code":"28","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20230284","operator_company_name":"옐로씨펀드","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '이앤벤처파트너스',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20250147","registration_date":"2025-02-26","expiry_date":"2033-02-25","formation_total_amount":"500.0","investment_character_code":"18","industry_code":"9","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000022","operator_company_id":"OP20180007","operator_company_name":"이앤벤처파트너스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '크릿벤처스',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20220563","registration_date":"2022-05-19","expiry_date":"2029-05-18","formation_total_amount":"300.0","investment_character_code":"21","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20200352","operator_company_name":"크릿벤처스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '마젤란기술투자',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20240334","registration_date":"2024-04-22","expiry_date":"2029-04-21","formation_total_amount":"27.0","investment_character_code":"16","industry_code":"3","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20110007","operator_company_name":"마젤란기술투자","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '마젤란기술투자',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20210857","registration_date":"2021-09-14","expiry_date":"2026-09-13","formation_total_amount":"33.5","investment_character_code":"25","industry_code":"2","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP20110007","operator_company_name":"마젤란기술투자","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '엠벤처투자',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20080015","registration_date":"2008-01-11","expiry_date":"2025-06-30","formation_total_amount":"425.0","investment_character_code":"15","industry_code":"1","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"MF00000001","operator_company_id":"OP19860003","operator_company_name":"엠벤처투자","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '엠엠에스벤처스',
  NULL,
  '{"fund_id":"AS20240432","registration_date":"2024-05-31","expiry_date":"2031-05-19","formation_total_amount":"3.2","investment_character_code":"","industry_code":"2","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20200468","operator_company_name":"엠엠에스벤처스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '엠엠에스벤처스',
  NULL,
  '{"fund_id":"AS20220948","registration_date":"2022-08-31","expiry_date":"2029-08-16","formation_total_amount":"2.6","investment_character_code":"","industry_code":"2","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20200468","operator_company_name":"엠엠에스벤처스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '엠엠에스벤처스',
  NULL,
  '{"fund_id":"AS20241011","registration_date":"2024-10-28","expiry_date":"2031-10-21","formation_total_amount":"2.7","investment_character_code":"","industry_code":"2","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20200468","operator_company_name":"엠엠에스벤처스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '엠엠에스벤처스',
  NULL,
  '{"fund_id":"AS20220416","registration_date":"2022-04-18","expiry_date":"2029-04-13","formation_total_amount":"3.2","investment_character_code":"","industry_code":"3","investment_field_type":"","investment_field_detail_type":"","mother_fund_id":"","operator_company_id":"OP20200468","operator_company_name":"엠엠에스벤처스","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
INSERT INTO fund_table (
  ...
  '미래에셋벤처투자',
  '{"중소/벤처일반","일반"}',
  '{"fund_id":"AS20210500","registration_date":"2021-06-21","expiry_date":"2028-06-20","formation_total_amount":"230.0","investment_character_code":"02","industry_code":"7","investment_field_type":"일반","investment_field_detail_type":"중소/벤처일반","mother_fund_id":"","operator_company_id":"OP19990017","operator_company_name":"미래에셋벤처투자","source_url":"https://www.vcs.go.kr/web/portal/fund/search","extracted_at":"2025-06-05T00:34:30.243Z"}'::jsonb,
  'VCS_API_SCRAPER'
)
ON CONFLICT (company_id, fund_name) DO UPDATE SET
  fund_type = EXCLUDED.fund_type,
...
-- Corrected Batch 28 completed! 50 fund records processed.
