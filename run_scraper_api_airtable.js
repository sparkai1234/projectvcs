...
// const AIRTABLE_VC_TABLE_NAME = process.env.AIRTABLE_VC_TABLE_NAME; // Removed
...
async function runScraper() {
    try {
        console.log('Starting VCS scraper actor via API...');
        ...
        // Run your custom scraper actor (VCS data)
        ...
        const run = await client.actor("ECFcJkFqhtxYGqqGy").call({
            ...
            dataType: 'VC', // Specify the data type
            ...
            airtableTableName: process.env.AIRTABLE_VC_TABLE_NAME, // Pass from local .env for actor input
        });

        console.log('VCS scraper actor finished successfully. Run ID:', run.id);
        ...
        console.error('Error starting VCS scraper actor:', error);
    }
}
